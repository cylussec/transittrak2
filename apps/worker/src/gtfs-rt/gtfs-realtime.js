...
export const transit_realtime = $root.transit_realtime = (() => {
    ...
    transit_realtime.TripUpdate = (function() {
         ...
         * @property {Array.<transit_realtime.IStopTimeUpdate>|null} [stopTimeUpdate] TripUpdate stopTimeUpdate
         ...
         * @member {Array.<transit_realtime.IStopTimeUpdate>} stopTimeUpdate
         * @memberof transit_realtime.TripUpdate
         * @instance
         */
        ...
        TripUpdate.encode = function encode(message, writer) {
            ...
            if (message.stopTimeUpdate != null && message.stopTimeUpdate.length)
                for (let i = 0; i < message.stopTimeUpdate.length; ++i)
                    $root.transit_realtime.StopTimeUpdate.encode(message.stopTimeUpdate[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.vehicle != null && Object.hasOwnProperty.call(message, "vehicle"))
        ...
        TripUpdate.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 2: {
                        ...
                        message.stopTimeUpdate.push($root.transit_realtime.StopTimeUpdate.decode(reader, reader.uint32()));
                        break;
                    }
                case 4: {
                        message.timestamp = reader.uint64();
        ...
        TripUpdate.verify = function verify(message) {
            ...
            if (message.stopTimeUpdate != null && message.hasOwnProperty("stopTimeUpdate")) {
                ...
                for (let i = 0; i < message.stopTimeUpdate.length; ++i) {
                    let error = $root.transit_realtime.StopTimeUpdate.verify(message.stopTimeUpdate[i]);
                    if (error)
        ...
        TripUpdate.fromObject = function fromObject(object) {
            ...
            if (object.stopTimeUpdate) {
                ...
                for (let i = 0; i < object.stopTimeUpdate.length; ++i) {
                    ...
                    message.stopTimeUpdate[i] = $root.transit_realtime.StopTimeUpdate.fromObject(object.stopTimeUpdate[i]);
                }
            }
            if (object.timestamp != null)
                if ($util.Long)
        ...
        TripUpdate.toObject = function toObject(message, options) {
            ...
            if (message.stopTimeUpdate && message.stopTimeUpdate.length) {
                ...
                for (let j = 0; j < message.stopTimeUpdate.length; ++j)
                    object.stopTimeUpdate[j] = $root.transit_realtime.StopTimeUpdate.toObject(message.stopTimeUpdate[j], options);
            }
            if (message.vehicle != null && message.hasOwnProperty("vehicle"))
    ...
    transit_realtime.StopTimeUpdate = (function() {
         ...
         * @property {transit_realtime.IStopTimeEvent|null} [arrival] StopTimeUpdate arrival
         * @property {transit_realtime.IStopTimeEvent|null} [departure] StopTimeUpdate departure
         * @property {transit_realtime.StopTimeUpdate.ScheduleRelationship|null} [scheduleRelationship] StopTimeUpdate scheduleRelationship
         */
         ...
         * @constructor
         * @param {transit_realtime.IStopTimeUpdate=} [properties] Properties to set
         */
         ...
         * @memberof transit_realtime.StopTimeUpdate
         * @instance
         */
         ...
         * @member {transit_realtime.IStopTimeEvent|null|undefined} arrival
         * @memberof transit_realtime.StopTimeUpdate
         * @instance
         */
         ...
         * @member {transit_realtime.IStopTimeEvent|null|undefined} departure
         * @memberof transit_realtime.StopTimeUpdate
         * @instance
         */
         ...
         * @member {transit_realtime.StopTimeUpdate.ScheduleRelationship} scheduleRelationship
         * @memberof transit_realtime.StopTimeUpdate
         * @instance
         */
         ...
         * @static
         * @param {transit_realtime.IStopTimeUpdate=} [properties] Properties to set
         * @returns {transit_realtime.StopTimeUpdate} StopTimeUpdate instance
         */
        ...
        /**
         * Encodes the specified StopTimeUpdate message. Does not implicitly {@link transit_realtime.StopTimeUpdate.verify|verify} messages.
         * @function encode
         * @memberof transit_realtime.StopTimeUpdate
         * @static
         * @param {transit_realtime.IStopTimeUpdate} message StopTimeUpdate message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        StopTimeUpdate.encode = function encode(message, writer) {
            ...
            if (message.arrival != null && Object.hasOwnProperty.call(message, "arrival"))
                $root.transit_realtime.StopTimeEvent.encode(message.arrival, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.departure != null && Object.hasOwnProperty.call(message, "departure"))
                $root.transit_realtime.StopTimeEvent.encode(message.departure, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        ...
        /**
         * Encodes the specified StopTimeUpdate message, length delimited. Does not implicitly {@link transit_realtime.StopTimeUpdate.verify|verify} messages.
         * @function encodeDelimited
         * @memberof transit_realtime.StopTimeUpdate
         * @static
         * @param {transit_realtime.IStopTimeUpdate} message StopTimeUpdate message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {transit_realtime.StopTimeUpdate} StopTimeUpdate
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StopTimeUpdate.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.StopTimeUpdate();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        message.arrival = $root.transit_realtime.StopTimeEvent.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.departure = $root.transit_realtime.StopTimeEvent.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
        ...
        StopTimeUpdate.verify = function verify(message) {
            ...
            if (message.arrival != null && message.hasOwnProperty("arrival")) {
                let error = $root.transit_realtime.StopTimeEvent.verify(message.arrival);
                if (error)
                    return "arrival." + error;
            }
            if (message.departure != null && message.hasOwnProperty("departure")) {
                let error = $root.transit_realtime.StopTimeEvent.verify(message.departure);
                if (error)
        ...
        StopTimeUpdate.fromObject = function fromObject(object) {
            if (object instanceof $root.transit_realtime.StopTimeUpdate)
                return object;
            let message = new $root.transit_realtime.StopTimeUpdate();
            ...
            if (object.arrival != null) {
                if (typeof object.arrival !== "object")
                    throw TypeError(".transit_realtime.StopTimeUpdate.arrival: object expected");
                message.arrival = $root.transit_realtime.StopTimeEvent.fromObject(object.arrival);
            }
            if (object.departure != null) {
                if (typeof object.departure !== "object")
                    throw TypeError(".transit_realtime.StopTimeUpdate.departure: object expected");
                message.departure = $root.transit_realtime.StopTimeEvent.fromObject(object.departure);
            }
         ...
         * @memberof transit_realtime.StopTimeUpdate
         * @static
         * @param {transit_realtime.StopTimeUpdate} message StopTimeUpdate
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        StopTimeUpdate.toObject = function toObject(message, options) {
            ...
            if (message.arrival != null && message.hasOwnProperty("arrival"))
                object.arrival = $root.transit_realtime.StopTimeEvent.toObject(message.arrival, options);
            if (message.departure != null && message.hasOwnProperty("departure"))
                object.departure = $root.transit_realtime.StopTimeEvent.toObject(message.departure, options);
            if (message.stopId != null && message.hasOwnProperty("stopId"))
                object.stopId = message.stopId;
            if (message.scheduleRelationship != null && message.hasOwnProperty("scheduleRelationship"))
                object.scheduleRelationship = options.enums === String ? $root.transit_realtime.StopTimeUpdate.ScheduleRelationship[message.scheduleRelationship] === undefined ? message.scheduleRelationship : $root.transit_realtime.StopTimeUpdate.ScheduleRelationship[message.scheduleRelationship] : message.scheduleRelationship;
            return object;
        };
        ...
        StopTimeUpdate.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.StopTimeUpdate";
        };

        /**
         * ScheduleRelationship enum.
         * @name transit_realtime.StopTimeUpdate.ScheduleRelationship
         * @enum {number}
    ...
    transit_realtime.StopTimeEvent = (function() {
         ...
         * @constructor
         * @param {transit_realtime.IStopTimeEvent=} [properties] Properties to set
         */
         ...
         * StopTimeEvent delay.
         * @member {number} delay
         * @memberof transit_realtime.StopTimeEvent
         * @instance
         */
         ...
         * @static
         * @param {transit_realtime.IStopTimeEvent=} [properties] Properties to set
         * @returns {transit_realtime.StopTimeEvent} StopTimeEvent instance
         */
        ...
        /**
         * Encodes the specified StopTimeEvent message. Does not implicitly {@link transit_realtime.StopTimeEvent.verify|verify} messages.
         * @function encode
         * @memberof transit_realtime.StopTimeEvent
         * @static
         * @param {transit_realtime.IStopTimeEvent} message StopTimeEvent message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified StopTimeEvent message, length delimited. Does not implicitly {@link transit_realtime.StopTimeEvent.verify|verify} messages.
         * @function encodeDelimited
         * @memberof transit_realtime.StopTimeEvent
         * @static
         * @param {transit_realtime.IStopTimeEvent} message StopTimeEvent message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {transit_realtime.StopTimeEvent} StopTimeEvent
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        StopTimeEvent.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.transit_realtime.StopTimeEvent();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        StopTimeEvent.fromObject = function fromObject(object) {
            if (object instanceof $root.transit_realtime.StopTimeEvent)
                return object;
            let message = new $root.transit_realtime.StopTimeEvent();
            if (object.delay != null)
                message.delay = object.delay | 0;
            if (object.time != null)
                if ($util.Long)
         ...
         * @memberof transit_realtime.StopTimeEvent
         * @static
         * @param {transit_realtime.StopTimeEvent} message StopTimeEvent
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        StopTimeEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/transit_realtime.StopTimeEvent";
        };
